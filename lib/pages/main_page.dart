...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: pages[_selcetedIndex],
      bottomNavigationBar: _customButtomNav(),
    );
  }
          ...
          items: [
            BottomNavigationBarItem(
                icon: Image.asset(
                  ...
                  width: 24,
                  color: _selcetedIndex == 0 ? kBlueRibbon : kDarkGray,
                ),
                label: 'Home'),
            BottomNavigationBarItem(
                icon: Image.asset(
                  ...
                  width: 24,
                  color: _selcetedIndex == 1 ? kBlueRibbon : kDarkGray,
                ),
                label: 'Portofolio'),
            BottomNavigationBarItem(
                icon: Image.asset(
                  ...
                  width: 24,
                  color: _selcetedIndex == 2 ? kBlueRibbon : kDarkGray,
                ),
                label: 'Pupport'),
            BottomNavigationBarItem(
                icon: Image.asset(
                  ...
                  width: 24,
                  color: _selcetedIndex == 3 ? kBlueRibbon : kDarkGray,
                ),
                label: 'Profile'),
          ],
        ),
